...
public interface TeamRepository extends GraphRepository<Team>, TeamRepositoryExtension
{
	Team findByName(String name);

	@Query ("START team=node:Team(name={0}) MATCH team-[:CONTESTED_IN]->league RETURN league.name")
